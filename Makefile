...
obj	= main.o string.o var.o error.o math.o sbuf.o BaseFunction.o package.o func.o exfun.o
func	= func/function.o func/key.o func/con.o func/math.o func/string.o func/debug.o
