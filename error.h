...
#define errcl_Code	0x00010000
	...
	#define errty_CodeSys	errcl_Code|0x0300
		...
		#define errid_SysPackageBase	(errty_CodeSys|0x06)
		#define errid_SysPackageInit	(errty_CodeSys|0x07)
		#define errid_SysPackageNotfind	(errty_CodeSys|0x08)
		#define errid_SysPackageTakeup	(errty_CodeSys|0x09)
		#define errid_SysPackageDamage	(errty_CodeSys|0x0a)
		#define errid_SysFileNotLoad	(errty_CodeSys|0x0b)
...
#define errcl_Var	0x00030000
	...
	#define errty_VarExist	errcl_Var|0x0100
		...
		#define errid_VarReferFail	(errty_VarExist|0x06)
	// Var Type
